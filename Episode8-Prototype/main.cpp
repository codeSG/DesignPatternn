...
int main(){
    ...
    user1->createRecurringMeeting("Project discussion2", "Discuss", DateTime(26,7,2024), DateTime(28,7,2024),{user3}, DateTime(45,7,2024), 7);
    calendar1->viewAllMeetings();
    // Update Meetings

    // View Meetings
    user1->view(DateTime(16,7,2024), ViewType::DAY); 
    user1->view(DateTime(18,7,2024), ViewType::MONTH);
    return 0;
}